...
// CrystalDust graphics externs (D20).
...
extern const u8 gSignMessageBox_Gfx[];
...
extern const u32 gPokedexListJohto_Tilemap[];
extern const u32 gPokedexListNational_Tilemap[];
