...
enum
{
    ...
    OBJ_EVENT_GFX_BAYLEEF,
    OBJ_EVENT_GFX_BLISSEY,
    OBJ_EVENT_GFX_BOARDER,
    OBJ_EVENT_GFX_BOOK,
    OBJ_EVENT_GFX_BUENA,
    OBJ_EVENT_GFX_BUGSY,
    OBJ_EVENT_GFX_BUTTERFREE,
    OBJ_EVENT_GFX_CHUCK,
    OBJ_EVENT_GFX_CLAIR,
    OBJ_EVENT_GFX_DIGLETT,
    OBJ_EVENT_GFX_DODRIO,
    OBJ_EVENT_GFX_DRAGONITE,
    OBJ_EVENT_GFX_DRATINI,
    OBJ_EVENT_GFX_ELECTRODE,
    OBJ_EVENT_GFX_EUSINE,
    OBJ_EVENT_GFX_FALKNER,
    OBJ_EVENT_GFX_FARFETCHD,
    OBJ_EVENT_GFX_FIREBREATHER,
    OBJ_EVENT_GFX_GOLD_NORMAL,
    OBJ_EVENT_GFX_JASMINE,
    OBJ_EVENT_GFX_KAREN,
    OBJ_EVENT_GFX_KIMONO_GIRL_RED,
    OBJ_EVENT_GFX_KRIS_NORMAL,
    OBJ_EVENT_GFX_KURT,
    OBJ_EVENT_GFX_KURT_LYING_DOWN,
    OBJ_EVENT_GFX_MARILL,
    OBJ_EVENT_GFX_MILTANK,
    OBJ_EVENT_GFX_MORTY,
    OBJ_EVENT_GFX_MR_POKEMON,
    OBJ_EVENT_GFX_MURKROW,
    OBJ_EVENT_GFX_OFFICER,
    OBJ_EVENT_GFX_PERSIAN,
    OBJ_EVENT_GFX_POKEMANIAC,
    OBJ_EVENT_GFX_PROF_ELM,
    OBJ_EVENT_GFX_PRYCE,
    OBJ_EVENT_GFX_RATTATA,
    OBJ_EVENT_GFX_RED_GYARADOS,
    OBJ_EVENT_GFX_REDS_MOM,
    OBJ_EVENT_GFX_RHYDON,
    OBJ_EVENT_GFX_RIVAL,
    OBJ_EVENT_GFX_ROCKET_GRUNT_F,
    OBJ_EVENT_GFX_ROCKET_GRUNT_M,
    OBJ_EVENT_GFX_SAGE,
    OBJ_EVENT_GFX_SENTRET,
    OBJ_EVENT_GFX_SKIER,
    OBJ_EVENT_GFX_SS_AQUA,
    ...
    OBJ_EVENT_GFX_ZBIG_ONIX_DOLL,
    OBJ_EVENT_GFX_ZBULBASAUR_DOLL,
    OBJ_EVENT_GFX_ZCHARMANDER_DOLL,
    OBJ_EVENT_GFX_ZDIGLETT_DOLL,
    OBJ_EVENT_GFX_ZGENGAR_DOLL,
    OBJ_EVENT_GFX_ZGEODUDE_DOLL,
    OBJ_EVENT_GFX_ZGOLD_SHIELD,
    OBJ_EVENT_GFX_ZGOLD_TROPHY,
    OBJ_EVENT_GFX_ZGRIMER_DOLL,
    OBJ_EVENT_GFX_ZMACHOP_DOLL,
    OBJ_EVENT_GFX_ZMAGIKARP_DOLL,
    OBJ_EVENT_GFX_ZMAGNEMITE_DOLL,
    OBJ_EVENT_GFX_ZNATU_DOLL,
    OBJ_EVENT_GFX_ZODDISH_DOLL,
    OBJ_EVENT_GFX_ZPOLIWAG_DOLL,
    OBJ_EVENT_GFX_ZPORYGON2_DOLL,
    OBJ_EVENT_GFX_ZSHELLDER_DOLL,
    OBJ_EVENT_GFX_ZSILVER_SHIELD,
    OBJ_EVENT_GFX_ZSILVER_TROPHY,
    OBJ_EVENT_GFX_ZSQUIRTLE_DOLL,
    OBJ_EVENT_GFX_ZSTARYU_DOLL,
    OBJ_EVENT_GFX_ZSURFING_PIKACHU_DOLL,
    OBJ_EVENT_GFX_ZTENTACOOL_DOLL,
    OBJ_EVENT_GFX_ZUNOWN_DOLL,
...
// CrystalDust names for sprites expansion already has under another name (D43).
#define OBJ_EVENT_GFX_BATTLE_GIRL OBJ_EVENT_GFX_GIRL_3
#define OBJ_EVENT_GFX_GIRL OBJ_EVENT_GFX_GIRL_2
#define OBJ_EVENT_GFX_GYM_GUIDE OBJ_EVENT_GFX_MAN_2
#define OBJ_EVENT_GFX_WOMAN OBJ_EVENT_GFX_WOMAN_1
#define OBJ_EVENT_GFX_ZMR_BRINEYS_BOAT OBJ_EVENT_GFX_MR_BRINEYS_BOAT
#define OBJ_EVENT_GFX_ZNINJA_BOY OBJ_EVENT_GFX_NINJA_BOY
#define OBJ_EVENT_GFX_ZRICH_BOY OBJ_EVENT_GFX_RICH_BOY
#define OBJ_EVENT_GFX_ZSCOTT OBJ_EVENT_GFX_SCOTT
...
#define OBJ_EVENT_PAL_TAG_GOLD                     0x1170
#define OBJ_EVENT_PAL_TAG_KRIS                     0x1171
#define OBJ_EVENT_PAL_TAG_PROF_ELM                 0x1172
#define OBJ_EVENT_PAL_TAG_SILVER                   0x1173
#define OBJ_EVENT_PAL_TAG_BUTTERFREE               0x1174
#define OBJ_EVENT_PAL_TAG_WILL                     0x1175
#define OBJ_EVENT_PAL_TAG_RED_GYARADOS             0x1176
#define OBJ_EVENT_PAL_TAG_MURKROW                  0x1177
