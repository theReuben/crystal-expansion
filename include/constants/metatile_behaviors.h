...
enum {
    ...
    MB_PORTHOLE,
    MB_UNUSED_AB, // expansion's MB_WINDOW; CrystalDust's lives at 0x88 (D60)
    MB_CUP,
    MB_BLINKING_LIGHTS,
    ...
    MB_UNUSED_DA,
    MB_UNUSED_DB,
    MB_DECOR_POSTER, // CrystalDust, relocated from 0xEB (D60)
    MB_DECOR_CONSOLE, // CrystalDust, relocated from 0xEC (D60)
    MB_ANCIENT_POKEMON_REPLICA, // CrystalDust (D60)
    MB_DISTINGUISHED_STATUE, // CrystalDust (D60)
