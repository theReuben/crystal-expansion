...
enum __attribute__((packed)) TrainerPicID
{
    ...
    TRAINER_PIC_KRIS, // CrystalDust's female player (D59)
...
enum
{
    ...
    // CrystalDust's player characters (D59).
    FACILITY_CLASS_GOLD,
    FACILITY_CLASS_KRIS,
...
enum TrainerClassID
{
    ...
    TRAINER_CLASS_MYSTICALMAN,
    TRAINER_CLASS_OFFICER,
    TRAINER_CLASS_PKMN_TRAINER_3,
    TRAINER_CLASS_RIVAL1,
    TRAINER_CLASS_RIVAL2,
    TRAINER_CLASS_SAGE,
    ...
    TRAINER_CLASS_TEAM_ROCKET_EXECUTIVE,
...
#define TRAINER_ENCOUNTER_MUSIC_SAGE       15
#define TRAINER_ENCOUNTER_MUSIC_OFFICER    16
#define TRAINER_ENCOUNTER_MUSIC_ROCKET     17
#define TRAINER_ENCOUNTER_MUSIC_FISHERMAN  18
#define TRAINER_ENCOUNTER_MUSIC_KIMONO     19
