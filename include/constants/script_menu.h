...
enum
{
    ...
    MULTI_AMBER_CLAW,
    MULTI_AMBER_ROOT,
    MULTI_AMBER_ROOT_CLAW,
    MULTI_CELADON_GAME_CORNER_MONS,
    MULTI_CELADON_GAME_CORNER_TMS,
    MULTI_CLAW,
    MULTI_DOME_AMBER_CLAW,
    MULTI_DOME_AMBER_ROOT,
    MULTI_DOME_AMBER_ROOT_CLAW,
    MULTI_DOME_CLAW,
    MULTI_DOME_ROOT,
    MULTI_DOME_ROOT_CLAW,
    MULTI_DRAGON_SHRINE_QUESTION_1,
    MULTI_DRAGON_SHRINE_QUESTION_2,
    MULTI_DRAGON_SHRINE_QUESTION_3,
    MULTI_DRAGON_SHRINE_QUESTION_4,
    MULTI_DRAGON_SHRINE_QUESTION_5,
    MULTI_GAME_CORNER_MONS,
    MULTI_GAME_CORNER_TUTOR,
    MULTI_HELIX_AMBER_CLAW,
    MULTI_HELIX_AMBER_ROOT,
    MULTI_HELIX_AMBER_ROOT_CLAW,
    MULTI_HELIX_CLAW,
    MULTI_HELIX_DOME,
    MULTI_HELIX_DOME_AMBER,
    MULTI_HELIX_DOME_AMBER_CLAW,
    MULTI_HELIX_DOME_AMBER_ROOT,
    MULTI_HELIX_DOME_AMBER_ROOT_CLAW,
    MULTI_HELIX_DOME_CLAW,
    MULTI_HELIX_DOME_ROOT,
    MULTI_HELIX_DOME_ROOT_CLAW,
    MULTI_HELIX_ROOT,
    MULTI_HELIX_ROOT_CLAW,
    MULTI_MOM_BANK,
    MULTI_ROOT,
    MULTI_ROOT_CLAW,
};
