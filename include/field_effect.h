...
// CrystalDust's showmonpic takes a shininess flag (the Lake of Rage Gyarados),
// so this gained an isShiny parameter in Phase 2 (D42).
u8 CreateMonSprite_PicBox(enum Species species, s16 x, s16 y, u8 subpriority, bool8 isShiny);
