...
// CrystalDust strings, merged in Phase 2. See src/strings.c.
...
// CrystalDust string externs restored in Phase 2 (D20).
// Symbols already defined static in expansion sources are excluded.
