...
// Follower Pokémon
// Crystal Expansion (D109): on. Gen 2 is the generation that introduced a
// walking partner, and HG/SS -- the games this port is dressed as -- put the
// whole party's lead on screen, so followers off by default reads as missing
// content rather than a setting.
