    ...
    case OAKS_POKEMON_TALK_4:
        {
            static const struct {
                ...
                { MAPSEC_ROUTE_37, MAP_GROUP(MAP_ROUTE37), MAP_NUM(MAP_ROUTE37) },
                { MAPSEC_ROUTE_38, MAP_GROUP(MAP_ROUTE38), MAP_NUM(MAP_ROUTE38) },
                { MAPSEC_ROUTE_39, MAP_GROUP(MAP_ROUTE39), MAP_NUM(MAP_ROUTE39) },
                { MAPSEC_ROUTE_42, MAP_GROUP(MAP_ROUTE42), MAP_NUM(MAP_ROUTE42) },
                { MAPSEC_ROUTE_43, MAP_GROUP(MAP_ROUTE43), MAP_NUM(MAP_ROUTE43) },
                { MAPSEC_ROUTE_44, MAP_GROUP(MAP_ROUTE44), MAP_NUM(MAP_ROUTE44) },
                { MAPSEC_ROUTE_45, MAP_GROUP(MAP_ROUTE45), MAP_NUM(MAP_ROUTE45) },
    ...
    case PLACES_AND_PEOPLE_4:
        {
            ...
            else //person
            {
                static const u16 validTrainers[] = 
                {
                    ...
                    TRAINER_ELAINE,
                    TRAINER_EUGENE,
                    TRAINER_ERIC_GSC, // is unused Super Nerd Stan in Crystal
                    TRAINER_CLYDE,
                    TRAINER_ANTHONY_1,
                    TRAINER_DWAYNE_GSC, // is unused Biker Benny in Crystal
                    TRAINER_DUNCAN_GSC,
                    TRAINER_OTIS,
                    TRAINER_IRWIN,
