// Crystal Expansion (D115): 118 of the infos shared with CrystalDust carried
// expansion's palette tag rather than CrystalDust's, which is how the Pokemon
// Center nurse came out blonde (D114). The 80 whose art file is byte-identical
// to CrystalDust's are now back on CrystalDust's tag and palette slot -- if the
// pixels are theirs, the palette they were drawn against is theirs too. The
// remaining 38 have art that differs (mostly FRLG-derived Kanto NPCs, some on
// palette tags CrystalDust never had) and are left alone; they need looking at
// one by one.

// Crystal Expansion (D80): the player avatar is Gold and Kris, not Brendan and
// May. These infos keep expansion's Brendan/May names -- every avatar table and
// map in the tree points at OBJ_EVENT_GFX_BRENDAN_* -- but draw CrystalDust's
// art, which is what CrystalDust does too. Field move is the one sheet whose
// shape differs: Gold's is five 16x32 frames where Brendan's was 32x32.
...
// Crystal Expansion (D114): the art here is CrystalDust's pink-haired nurse, but
// the merge kept expansion's palette tag, which is Emerald's NPC_1 -- so she came
// out blonde. CrystalDust drew her against NPC_2.
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_ItemBall = { // D108
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_NPC_4,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 128,
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_ApricornRed = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_APRICORN_RED,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 128,
    .width = 16,
    .height = 16,
    ...
    .subspriteTables = sOamTables_16x16,
    .anims = sAnimTable_Inanimate,
    .images = sPicTable_ApricornFruit,
    .affineAnims = gDummySpriteAffineAnimTable,
};

const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_ApricornBlu = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_APRICORN_BLU,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 128,
    .width = 16,
    .height = 16,
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_ApricornYlw = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_APRICORN_YLW,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 128,
    .width = 16,
    .height = 16,
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_ApricornGrn = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_APRICORN_GRN,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 128,
    .width = 16,
    .height = 16,
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_ApricornPnk = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_APRICORN_PNK,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 128,
    .width = 16,
    .height = 16,
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_ApricornWht = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_APRICORN_WHT,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 128,
    .width = 16,
    .height = 16,
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_ApricornBlk = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_APRICORN_BLK,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 128,
    .width = 16,
    .height = 16,
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_SlowpokeTailless = {
    ...
    .subspriteTables = sOamTables_16x16,
    .anims = sAnimTable_Standard,
    .images = sPicTable_SlowpokeTailless,
    .affineAnims = gDummySpriteAffineAnimTable,
};
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Butterfree = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_BUTTERFREE,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 128,
    .width = 16,
    .height = 16,
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_SSAqua = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_SS_AQUA,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 4096,
    .width = 128,
    .height = 64,
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_SurfingPikachuDoll = {
    ...
    .subspriteTables = sOamTables_16x16,
    .anims = sAnimTable_Inanimate,
    .images = sPicTable_SurfingPikachuDoll,
    .affineAnims = gDummySpriteAffineAnimTable,
};
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_TentacoolDoll = {
    ...
    .subspriteTables = sOamTables_16x16,
    .anims = sAnimTable_Inanimate,
    .images = sPicTable_TentacoolDoll,
    .affineAnims = gDummySpriteAffineAnimTable,
};
