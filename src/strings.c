...
// ============================================================
// CrystalDust strings, merged in Phase 2.
// The Phase 1 three-way merge kept expansion's strings.c verbatim, which
// dropped every string CrystalDust had added. These are the CrystalDust-only
// symbols: present in CrystalDust's strings.h and defined in its strings.c,
// and not defined or declared anywhere in this tree (including file-local
// statics, which is why the exclusion set is built by scanning src/ and
// include/ rather than just strings.h).
// Names shared with expansion keep EXPANSION's text; re-checking that wording
// against Crystal is the Phase 5 text sweep, not this merge.
// ============================================================
