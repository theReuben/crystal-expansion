...
#define REMATCH(trainer1, trainer2, trainer3, trainer4, trainer5, map)  \
    REMATCH_PHONE(trainer1, trainer2, trainer3, trainer4, trainer5, map, PHONE_CONTACT_NONE)

#define REMATCH_PHONE(trainer1, trainer2, trainer3, trainer4, trainer5, map, phone) \
{                                                                       \
...
{
    // CrystalDust rematch entries (D19).
    [REMATCH_JOEY] = REMATCH_PHONE(TRAINER_JOEY_1, TRAINER_JOEY_2, TRAINER_JOEY_3, TRAINER_JOEY_4, TRAINER_JOEY_5, MAP_ROUTE30, PHONE_CONTACT_YOUNGSTER_JOEY),
    [REMATCH_WADE] = REMATCH_PHONE(TRAINER_WADE_1, TRAINER_WADE_2, TRAINER_WADE_3, TRAINER_WADE_4, TRAINER_WADE_5, MAP_ROUTE31, PHONE_CONTACT_BUG_CATCHER_WADE),
    [REMATCH_LIZ] = REMATCH_PHONE(TRAINER_LIZ_1, TRAINER_LIZ_2, TRAINER_LIZ_3, TRAINER_LIZ_4, TRAINER_LIZ_5, MAP_ROUTE32, PHONE_CONTACT_PICNICKER_LIZ),
    [REMATCH_RALPH] = REMATCH_PHONE(TRAINER_RALPH_1, TRAINER_RALPH_2, TRAINER_RALPH_3, TRAINER_RALPH_4, TRAINER_RALPH_5, MAP_ROUTE32, PHONE_CONTACT_FISHER_RALPH),
    [REMATCH_ANTHONY] = REMATCH_PHONE(TRAINER_ANTHONY_1, TRAINER_ANTHONY_2, TRAINER_ANTHONY_3, TRAINER_ANTHONY_4, TRAINER_ANTHONY_5, MAP_ROUTE33, PHONE_CONTACT_HIKER_ANTHONY),
    [REMATCH_TODD] = REMATCH_PHONE(TRAINER_TODD_1, TRAINER_TODD_2, TRAINER_TODD_3, TRAINER_TODD_4, TRAINER_TODD_5, MAP_ROUTE34, PHONE_CONTACT_CAMPER_TODD),
    [REMATCH_GINA] = REMATCH_PHONE(TRAINER_GINA_1, TRAINER_GINA_2, TRAINER_GINA_3, TRAINER_GINA_4, TRAINER_GINA_5, MAP_ROUTE34, PHONE_CONTACT_PICNICKER_GINA),
    [REMATCH_ARNIE] = REMATCH_PHONE(TRAINER_ARNIE_1, TRAINER_ARNIE_2, TRAINER_ARNIE_3, TRAINER_ARNIE_4, TRAINER_ARNIE_5, MAP_ROUTE35, PHONE_CONTACT_BUG_CATCHER_ARNIE),
    [REMATCH_JACK] = REMATCH_PHONE(TRAINER_JACK_1, TRAINER_JACK_2, TRAINER_JACK_3, TRAINER_JACK_4, TRAINER_JACK_5, MAP_NATIONAL_PARK, PHONE_CONTACT_SCHOOLBOY_JACK),
    [REMATCH_ALAN] = REMATCH_PHONE(TRAINER_ALAN_1, TRAINER_ALAN_2, TRAINER_ALAN_3, TRAINER_ALAN_4, TRAINER_ALAN_5, MAP_ROUTE36, PHONE_CONTACT_SCHOOLBOY_ALAN),
    [REMATCH_DANA] = REMATCH_PHONE(TRAINER_DANA_1, TRAINER_DANA_2, TRAINER_DANA_3, TRAINER_DANA_4, TRAINER_DANA_5, MAP_ROUTE38, PHONE_CONTACT_LASS_DANA),
    [REMATCH_CHAD] = REMATCH_PHONE(TRAINER_CHAD_1, TRAINER_CHAD_2, TRAINER_CHAD_3, TRAINER_CHAD_4, TRAINER_NONE, MAP_ROUTE38, PHONE_CONTACT_SCHOOLBOY_CHAD),
    [REMATCH_HUEY] = REMATCH_PHONE(TRAINER_HUEY_1, TRAINER_HUEY_2, TRAINER_HUEY_3, TRAINER_HUEY_4, TRAINER_NONE, MAP_LIGHTHOUSE_2F, PHONE_CONTACT_SAILOR_HUEY),
    [REMATCH_TULLY] = REMATCH_PHONE(TRAINER_TULLY_1, TRAINER_TULLY_2, TRAINER_TULLY_3, TRAINER_TULLY_4, TRAINER_NONE, MAP_ROUTE42, PHONE_CONTACT_FISHER_TULLY),
    [REMATCH_TIFFANY] = REMATCH_PHONE(TRAINER_TIFFANY_1, TRAINER_TIFFANY_2, TRAINER_TIFFANY_3, TRAINER_TIFFANY_4, TRAINER_NONE, MAP_ROUTE43, PHONE_CONTACT_PICNICKER_TIFFANY),
    [REMATCH_BRENT] = REMATCH_PHONE(TRAINER_BRENT_1, TRAINER_BRENT_2, TRAINER_BRENT_3, TRAINER_BRENT_4, TRAINER_NONE, MAP_ROUTE43, PHONE_CONTACT_POKEMANIAC_BRENT),
    [REMATCH_WILTON_GSC] = REMATCH_PHONE(TRAINER_WILTON_1_GSC, TRAINER_WILTON_2_GSC, TRAINER_WILTON_3_GSC, TRAINER_NONE, TRAINER_NONE, MAP_ROUTE44, PHONE_CONTACT_FISHER_WILTON),
    [REMATCH_VANCE] = REMATCH_PHONE(TRAINER_VANCE_1, TRAINER_VANCE_2, TRAINER_VANCE_3, TRAINER_NONE, TRAINER_NONE, MAP_ROUTE44, PHONE_CONTACT_BIRD_KEEPER_VANCE),
    [REMATCH_PARRY] = REMATCH_PHONE(TRAINER_PARRY_1, TRAINER_PARRY_2, TRAINER_PARRY_3, TRAINER_NONE, TRAINER_NONE, MAP_ROUTE45, PHONE_CONTACT_HIKER_PARRY),
    [REMATCH_ERIN] = REMATCH_PHONE(TRAINER_ERIN_1, TRAINER_ERIN_2, TRAINER_ERIN_3, TRAINER_NONE, TRAINER_NONE, MAP_ROUTE46, PHONE_CONTACT_PICNICKER_ERIN),
    [REMATCH_JOSE] = REMATCH_PHONE(TRAINER_JOSE_1, TRAINER_JOSE_2, TRAINER_JOSE_3, TRAINER_NONE, TRAINER_NONE, MAP_ROUTE27, PHONE_CONTACT_BIRD_KEEPER_JOSE),
    [REMATCH_REENA] = REMATCH_PHONE(TRAINER_REENA_1, TRAINER_REENA_2, TRAINER_REENA_3, TRAINER_NONE, TRAINER_NONE, MAP_ROUTE26, PHONE_CONTACT_COOLTRAINER_REENA),
    [REMATCH_GAVEN] = REMATCH_PHONE(TRAINER_GAVEN_1, TRAINER_GAVEN_2, TRAINER_GAVEN_3, TRAINER_NONE, TRAINER_NONE, MAP_ROUTE26, PHONE_CONTACT_COOLTRAINER_GAVEN),
    [REMATCH_BETH] = REMATCH_PHONE(TRAINER_BETH_1, TRAINER_BETH_2, TRAINER_BETH_3, TRAINER_NONE, TRAINER_NONE, MAP_ROUTE26, PHONE_CONTACT_COOLTRAINER_BETH),
