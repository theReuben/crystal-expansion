...
const u16 gJohtoTrainerCard0Star_Pal[] = INCGFX_U16("graphics/trainer_card/0star_cd.pal", ".gbapal");
const u32 gJohtoTrainerCard_Gfx[] = INCGFX_U32("graphics/trainer_card/card_cd.png", ".4bpp.smol");
const u32 gJohtoTrainerCardBg_Tilemap[] = INCGFX_U32("graphics/trainer_card/bg_cd.bin", ".smolTM");
const u32 gJohtoTrainerCardFront_Tilemap[] = INCGFX_U32("graphics/trainer_card/front_cd.bin", ".smolTM");
const u32 gJohtoTrainerCardBack_Tilemap[] = INCGFX_U32("graphics/trainer_card/back_cd.bin", ".smolTM");
const u32 gJohtoTrainerCardFrontLink_Tilemap[] = INCGFX_U32("graphics/trainer_card/front_link_cd.bin", ".smolTM");
