...
const struct PhoneContact gPhoneContacts[PHONE_CONTACT_COUNT] =
{
    [PHONE_CONTACT_MOM] = {
        ...
        .mapNum = MAP_NUM(MAP_NEW_BARK_TOWN_PLAYERS_HOUSE_1F),
        .mapGroup = MAP_GROUP(MAP_NEW_BARK_TOWN_PLAYERS_HOUSE_1F),
        .registeredFlag = FLAG_PHONE_CARD_MOM,
        .rematchTrainerId = 0xFF,
		.trainerId = TRAINER_NONE_GSC,
        .isPermanent = TRUE,
    },
    [PHONE_CONTACT_ELM] = {
        .customDisplayName = sPhoneContactName_ProfessorElm,
        .phoneScript = PhoneScript_Elm,
        .mapNum = MAP_NUM(MAP_NEW_BARK_TOWN_PROFESSOR_ELMS_LAB),
        .mapGroup = MAP_GROUP(MAP_NEW_BARK_TOWN_PROFESSOR_ELMS_LAB),
    ...
    [PHONE_CONTACT_BIKE_SHOP] = {
        ...
        .mapNum = MAP_NUM(MAP_GOLDENROD_CITY_BIKE_SHOP),
        .mapGroup = MAP_GROUP(MAP_GOLDENROD_CITY_BIKE_SHOP),
        .registeredFlag = 0,
        .rematchTrainerId = 0xFF,
		.trainerId = TRAINER_NONE_GSC,
        .isPermanent = TRUE,
    ...
    [PHONE_CONTACT_BUENA] = {
        ...
        .mapNum = MAP_NUM(MAP_RADIO_TOWER_2F),
        .mapGroup = MAP_GROUP(MAP_RADIO_TOWER_2F),
    ...
    [PHONE_CONTACT_YOUNGSTER_JOEY] = {
        ...
        .mapNum = MAP_NUM(MAP_ROUTE30),
        .mapGroup = MAP_GROUP(MAP_ROUTE30),
    ...
    [PHONE_CONTACT_BUG_CATCHER_WADE] = {
		...
		.mapNum = MAP_NUM(MAP_ROUTE31),
		.mapGroup = MAP_GROUP(MAP_ROUTE31),
    ...
    [PHONE_CONTACT_CAMPER_TODD] = {
        ...
        .mapNum = MAP_NUM(MAP_ROUTE34),
        .mapGroup = MAP_GROUP(MAP_ROUTE34),
    ...
    [PHONE_CONTACT_BUG_CATCHER_ARNIE] = {
        ...
        .phoneScript = PhoneScript_StandardMatchCallTrainer,
        .mapNum = MAP_NUM(MAP_ROUTE35),
        .mapGroup = MAP_GROUP(MAP_ROUTE35),
    ...
    [PHONE_CONTACT_SCHOOLBOY_JACK] = {
        ...
        .phoneScript = PhoneScript_StandardMatchCallTrainer,
        .mapNum = MAP_NUM(MAP_NATIONAL_PARK),
        .mapGroup = MAP_GROUP(MAP_NATIONAL_PARK),
    ...
    [PHONE_CONTACT_POKEFAN_BEVERLY] = {
        ...
        .rematchTrainerId = 0xFF,
		.trainerId = TRAINER_BEVERLY_GSC,
        .isPermanent = FALSE,
    },
    [PHONE_CONTACT_SCHOOLBOY_ALAN] = {
        .customDisplayName = sPhoneContactName_Schoolboy_Alan,
        .phoneScript = PhoneScript_StandardMatchCallTrainer,
        .mapNum = MAP_NUM(MAP_ROUTE36),
        .mapGroup = MAP_GROUP(MAP_ROUTE36),
    ...
    [PHONE_CONTACT_LASS_DANA] = {
        ...
        .phoneScript = PhoneScript_StandardMatchCallTrainer,
        .mapNum = MAP_NUM(MAP_ROUTE38),
        .mapGroup = MAP_GROUP(MAP_ROUTE38),
    ...
    [PHONE_CONTACT_POKEFAN_DEREK] = {
        ...
        .rematchTrainerId = 0xFF,
		.trainerId = TRAINER_DEREK_GSC,
        .isPermanent = FALSE,
    },
    [PHONE_CONTACT_SAILOR_HUEY] = {
        .customDisplayName = sPhoneContactName_Sailor_Huey,
        .phoneScript = PhoneScript_StandardMatchCallTrainer,
        .mapNum = MAP_NUM(MAP_LIGHTHOUSE_2F),
        .mapGroup = MAP_GROUP(MAP_LIGHTHOUSE_2F),
    ...
    [PHONE_CONTACT_FISHER_TULLY] = {
        ...
        .phoneScript = PhoneScript_StandardMatchCallTrainer,
        .mapNum = MAP_NUM(MAP_ROUTE42),
        .mapGroup = MAP_GROUP(MAP_ROUTE42),
    ...
    [PHONE_CONTACT_PICNICKER_TIFFANY] = {
        ...
        .phoneScript = PhoneScript_StandardMatchCallTrainer,
        .mapNum = MAP_NUM(MAP_ROUTE43),
        .mapGroup = MAP_GROUP(MAP_ROUTE43),
    ...
    [PHONE_CONTACT_FISHER_WILTON] = {
        ...
        .phoneScript = PhoneScript_StandardMatchCallTrainer,
        .mapNum = MAP_NUM(MAP_ROUTE44),
        .mapGroup = MAP_GROUP(MAP_ROUTE44),
        .registeredFlag = FLAG_PHONE_CARD_FISHER_WILTON,
        .rematchTrainerId = REMATCH_WILTON_GSC,
		.trainerId = TRAINER_WILTON_1_GSC,
        .isPermanent = FALSE,
    },
    ...
    [PHONE_CONTACT_HIKER_PARRY] = {
        ...
        .mapNum = MAP_NUM(MAP_ROUTE45),
        .mapGroup = MAP_GROUP(MAP_ROUTE45),
    ...
    [PHONE_CONTACT_PICNICKER_ERIN] = {
        ...
        .mapNum = MAP_NUM(MAP_ROUTE46),
        .mapGroup = MAP_GROUP(MAP_ROUTE46),
    ...
    [PHONE_CONTACT_COOLTRAINER_REENA] = {
        ...
        .mapNum = MAP_NUM(MAP_ROUTE26),
        .mapGroup = MAP_GROUP(MAP_ROUTE26),
