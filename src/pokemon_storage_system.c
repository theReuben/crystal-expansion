...
} static const sRestrictedReleaseMoves[] =
{
    ...
    // Johto's Victory Road is the one map you can strand yourself on by releasing
    // your Strength user; Hoenn's Pokemon League rows were stub maps (D72).
    {MAP_GROUP(MAP_VICTORY_ROAD), MAP_NUM(MAP_VICTORY_ROAD), MOVE_STRENGTH},
};
