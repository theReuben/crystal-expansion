...
// CrystalDust's Johto Pokemon Centers (D65). Expansion's side kept the Hoenn
// list, whose constants are now stubs, so no Center ever set POKECENTER_SAVEWARP.
static const u16 sSaveLocationPokeCenterList[] =
{
    ...
    // CrystalDust's own list stops at Blackthorn; Kanto's Centers are added
    // here so they set POKECENTER_SAVEWARP too (D65).
