...
// Crystal Expansion (D82): the Bug Catching Contest's action menu reads
// "Fight/Pokemon/Ball/Run" with a ball count, so it is one tile wider and
// one tile further left than the standard one; everything else matches.
static const struct WindowTemplate sBugCatchingContestBattleWindowTemplates[] =
{
    [B_WIN_MSG] = {
        .bg = 0,
        .tilemapLeft = 2,
...
const struct WindowTemplate *const gBattleWindowTemplates[] =
{
    ...
    [B_WIN_TYPE_BUG_CATCHING_CONTEST] = sBugCatchingContestBattleWindowTemplates, // Crystal Expansion (D82)
};
...
void BattleInitBgsAndWindows(void)
{
    ...
    {
        gBattleScripting.windowsType = B_WIN_TYPE_BUG_CATCHING_CONTEST; // Crystal Expansion (D82)
    }
