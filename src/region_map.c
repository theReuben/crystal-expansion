...
// CrystalDust's Fly destinations (D67). Expansion kept its Hoenn table, whose
// map constants are now stubs, so every Fly target was a nonexistent map.
// MAPSEC_ROUTE_3_FLYDUP / MAPSEC_ROUTE_10_FLYDUP are absent per D33.
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_ROUTE_32_FLYDUP] = {MAP_GROUP(MAP_ROUTE32), MAP_NUM(MAP_ROUTE32), HEAL_LOCATION_ROUTE32},
    [MAPSEC_LAKE_OF_RAGE] = {MAP_GROUP(MAP_LAKE_OF_RAGE), MAP_NUM(MAP_LAKE_OF_RAGE), HEAL_LOCATION_LAKE_OF_RAGE},
    [MAPSEC_SILVER_CAVE] = {MAP_GROUP(MAP_SILVER_CAVE_OUTSIDE), MAP_NUM(MAP_SILVER_CAVE_OUTSIDE), HEAL_LOCATION_SILVER_CAVE_OUTSIDE},
    ...
    [MAPSEC_INDIGO_PLATEAU] = {MAP_GROUP(MAP_ROUTE23), MAP_NUM(MAP_ROUTE23), HEAL_LOCATION_ROUTE23},
};
...
static u8 GetMapsecType(mapsec_u16_t mapSecId)
{
    ...
    // CrystalDust's Johto Fly destinations (D67).
    ...
    case MAPSEC_ROUTE_32_FLYDUP:
        return FlagGet(FLAG_LANDMARK_ROUTE_32_POKEMON_CENTER) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_LAKE_OF_RAGE:
        return FlagGet(FLAG_LANDMARK_LAKE_OF_RAGE) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_SILVER_CAVE:
        return FlagGet(FLAG_LANDMARK_SILVER_CAVE) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
...
static const struct FlyLocation sFlyLocations[] =
{
    ...
    {
        .regionMapType = REGION_MAP_JOHTO,
        .mapsec = MAPSEC_ROUTE_32_FLYDUP,
        .flag = FLAG_LANDMARK_ROUTE_32_POKEMON_CENTER,
    },
    {
        .regionMapType = REGION_MAP_JOHTO,
        .mapsec = MAPSEC_LAKE_OF_RAGE,
        .flag = FLAG_LANDMARK_LAKE_OF_RAGE,
    },
    {
        .regionMapType = REGION_MAP_JOHTO,
        .mapsec = MAPSEC_SILVER_CAVE,
        .flag = FLAG_LANDMARK_SILVER_CAVE,
    },
    {
...
u32 FilterFlyDestination(struct RegionMap* regionMap)
{
    ...
    {
    // CrystalDust has no Hoenn special cases here; every Fly destination is a
    // plain heal location (D67). The Battle Frontier row is parked under Q3.
